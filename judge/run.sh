...
docker run --rm -it -e MARKPATH=/home/mark -e PROBPATH=/home/prob/ -v ${CodiDir}/judge:/home/judge -v ${CodiDir}/volume/mark_no/${code}:/home/mark -v ${CodiDir}/volume/prob_no/${data}:/home/prob --memory="2g" codi_judge:2.0 /bin/bash
